...
def download_audio(youtube_url: str, directory: str, status_printer = print):
    ...
    try:
        ...
        print_error_with_func(f"Error: Something internal went wrong (DEBUG: {e})", status_printer)
    except ValueError:
...
def convert_mp4_to_mp3(mp4_location: str, mp3_location: str):
    """Converts the mp4 at the mp4 location to an mp3 that will be put in the mp3 location"""
